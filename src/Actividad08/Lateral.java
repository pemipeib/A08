...
//    Localidades de la  zona
    final int LOCALIDADES = 100;
    //    Zona
    final Zona ZONA= Zona.Lateral;
    //    Precio de la zona
    final float PRECIO= 15.5f;
    //     Precio reducido de la zona
    final float PRECIOREDUCIDO= 10f;
    //    Precio con descuento de la zona
    final float PRECIOREDESCUENTO= PRECIO / 100 * Descuento.DESCUENTO;

    //    Constructor
    public Lateral(int entradasVendidas, String numeroEntrada) {
